    ...
    <ScrollArea className="h-full">
      <div className="p-4 space-y-6 max-w-2xl mx-auto">
        ...
        <div className="rounded-xl bg-card border-l-[3px] border-l-primary p-4">
          <h3 className="text-xs font-semibold text-primary uppercase tracking-wider mb-3">30-Second Pitch</h3>
          <p className="text-sm leading-relaxed">
            &ldquo;We&rsquo;re <span className="text-primary font-semibold">HyperVerge</span> — we built an AI Co-Pilot that cuts small business underwriting from{" "}
        ...
        {/* Social Proof */}
        <div>
          <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">Social Proof</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {collateral.map((item, i) => (
              ...
              >
                <span className="w-7 h-7 rounded-md bg-[var(--sqo)]/12 text-[var(--sqo)] flex items-center justify-center text-xs shrink-0">▶</span>
