      ...
      <div className="p-4 space-y-4 max-w-2xl mx-auto">
        ...
        <Card className="p-3 gap-2 shadow-none bg-brand/5 border-brand/20">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            {[
              "Yellowstone $1B Settlement — MCA regulation shockwave, every funder re-examining agreements",
              "AI in Underwriting — Jay 93% accuracy, Aakanksha GenAI at Mastercard, Biz2X agent, Plaid LendScore",
              "Raistone Collapse — Angel lived through it. Client concentration risk = cautionary tale",
              "Goldman Sachs Alumni — Kos Joshi + Aman Mahajan likely know each other; shared vocabulary",
              "Embedded Finance — Raistone (now defunct), Goldman/iBusiness Amazon, Mastercard Agent Suite (Jan 2026)",
              "Document Fraud Epidemic — GenAI synthetic docs, 30% YoY biz identity theft. HyperVerge angle.",
            ].map((theme, i) => (
              <div
                key={i}
