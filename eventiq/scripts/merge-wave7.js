...
/**
 * merge-wave7.js — Merge 50 researched companies from Wave 7 batch files
 * into src/data/all-companies.json
 *
 * Usage: node scripts/merge-wave7.js
 */
...
const BATCH_FILES = [
  path.join(__dirname, 'p4-wave7-batch-1.json'),
  path.join(__dirname, 'p4-wave7-batch-2.json'),
  path.join(__dirname, 'p4-wave7-batch-3.json'),
  path.join(__dirname, 'p4-wave7-batch-4.json'),
  path.join(__dirname, 'p4-wave7-batch-5.json'),
];
