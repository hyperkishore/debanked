...
/**
 * merge-wave5.js — Merge 50 researched companies from Wave 5 batch files
 * into src/data/all-companies.json
 *
 * Usage: node scripts/merge-wave5.js
 */
...
const BATCH_FILES = [
  path.join(__dirname, 'p4-wave5-batch-1.json'),
  path.join(__dirname, 'p4-wave5-batch-2.json'),
  path.join(__dirname, 'p4-wave5-batch-3.json'),
  path.join(__dirname, 'p4-wave5-batch-4.json'),
  path.join(__dirname, 'p4-wave5-batch-5.json'),
];
